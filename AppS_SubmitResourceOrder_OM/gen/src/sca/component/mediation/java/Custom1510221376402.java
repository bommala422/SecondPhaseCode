...
/**
 * @generated
 *  Flow: ResourceOrderManagementMED_REQ Interface: GetResourceOrderMsg Operation: getResourceOrderMsg Type: request Custom Mediation: Prep_TimeOut/Fail_Msg
 */
public class Custom1510221376402 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- Sterling_ResourceOrderManagment module :  Timeout/Fail while invoking SRO BS module -----");
		String sourceKey = "";
		...
		out.fire(ExceptionHelper.processUndefinedError(smo, out,
				TPConstants.AppS_TIMEOUT_FAIL, sourceKey)); // propagate the service message object to the primitive that is wired to the 'out' terminal
