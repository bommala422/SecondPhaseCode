...
/**
 * @generated
 *  Flow: ResourceOrderManagementMED_REQ Interface: GetResourceOrderMsg Operation: getResourceOrderMsg Type: request Custom Mediation: Log_SRO_Req
 */
public class Custom1507487359506 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----------- Sterling_ResourceOrderManagment Module::: Log SubmitResourceOrder Req   --------------");
