...
/**
 * @generated
 *  Flow: ResourceOrderManagementMED_REQ Interface: GetResourceOrderMsg Operation: getResourceOrderMsg Type: request Custom Mediation: Prep_MapFailureMsg
 */
public class Custom1510221641415 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("-----Sterling_ResourceOrderManagment module : Map Failure -----");
		String sourceKey = "";
		...
		out.fire(ExceptionHelper.processUndefinedError(smo, out,
				TPConstants.BOMAP_XSLT_FAIL, sourceKey)); // propagate the service message object to the primitive that is wired to the 'out' terminal
