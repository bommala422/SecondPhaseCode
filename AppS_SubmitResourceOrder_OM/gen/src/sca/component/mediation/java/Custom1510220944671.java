...
/**
 * @generated
 *  Flow: ResourceOrderManagementMED_REQ Interface: GetResourceOrderMsg Operation: getResourceOrderMsg Type: request Custom Mediation: Log_Ack_Response
 */
public class Custom1510220944671 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- Sterling_ResourceOrderManagment module : Ack Response --------------");
