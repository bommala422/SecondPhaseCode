...
/**
 * @generated
 *  Flow: ServiceOrderManagementMED_REQ Interface: GetServiceOrderMsg Operation: getServiceOrderMsg Type: request Custom Mediation: Log_SSO_Req
 */
public class Custom1507027782287 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- Sterling_SubmitServiceOrder Module::: Log SubmitServiceOrder Req   --------------");
