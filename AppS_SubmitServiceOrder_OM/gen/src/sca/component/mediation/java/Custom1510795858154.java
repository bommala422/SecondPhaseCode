...
/**
 * @generated
 *  Flow: ServiceOrderManagementMED_REQ Interface: GetServiceOrderMsg Operation: getServiceOrderMsg Type: request Custom Mediation: Prep_TimeOut/Fail_Msg
 */
public class Custom1510795858154 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- Sterling_SubmitServiceOrder module :  Timeout/Fail while invoking SSO BS module -----");
		String sourceKey = "";
