...
/**
 * @generated
 *  Flow: ServiceOrderManagementMED_REQ Interface: GetServiceOrderMsg Operation: getServiceOrderMsg Type: request Custom Mediation: Prep_MapFailureMsg
 */
public class Custom1510795860302 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("-----Sterling_SubmitServiceOrder module : Map Failure -----");
		String sourceKey = "";
