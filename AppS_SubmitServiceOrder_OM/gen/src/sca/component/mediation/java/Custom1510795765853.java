...
/**
 * @generated
 *  Flow: ServiceOrderManagementMED_REQ Interface: GetServiceOrderMsg Operation: getServiceOrderMsg Type: request Custom Mediation: Log_Ack_Response
 */
public class Custom1510795765853 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- Sterling_SubmitServiceOrder Module::: Ack Response --------------");
