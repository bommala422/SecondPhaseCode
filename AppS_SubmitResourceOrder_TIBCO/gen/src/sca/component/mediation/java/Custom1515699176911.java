...
/**
 * @generated
 *  Flow: ResourceOrder_SDM_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Log_CreateAUC_Req
 */
public class Custom1515699176911 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- AppS_SubmitResourceOrder  TIBCO Module::: Log  ServiceActivation - CreateAUC  Request  --------------");
