...
/**
 * @generated
 *  Flow: ResourceOrder_3DS_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Prep_MapFailure_Msg
 */
public class Custom1515753789193 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- AppS_SubmitResourceOrder TIBCO module :  Map Failure -----");
		String sourceKey = "";
