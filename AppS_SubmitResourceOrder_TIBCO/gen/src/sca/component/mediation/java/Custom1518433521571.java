...
/**
 * @generated
 *  Flow: ResourceOrder_SDM_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Log_CreateEIR_Resp
 */
public class Custom1518433521571 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- AppS_SubmitResourceOrder  TIBCO Module::: Log  ServiceActivation - CreateEIR  Response  --------------");
