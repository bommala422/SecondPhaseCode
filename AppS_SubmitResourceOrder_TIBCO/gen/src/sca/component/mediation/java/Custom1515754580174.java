...
/**
 * @generated
 *  Flow: ResourceOrder_3DS_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Log_CreateSub_Resp
 */
public class Custom1515754580174 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- AppS_SubmitResourceOrder  TIBCO Module::: Log  ServiceActivation - CreateSub  Response  --------------");
		LinkedHashMap<String, String> keys = new LinkedHashMap<String, String>();
		try {
			keys.put("TransactionID ::",
