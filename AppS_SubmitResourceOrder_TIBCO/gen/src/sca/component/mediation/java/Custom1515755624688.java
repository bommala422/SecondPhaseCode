...
/**
 * @generated
 *  Flow: ResourceOrder_3DS_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Log_3DS_CreateSub_Req
 */
public class Custom1515755624688 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- AppS_SubmitResourceOrder  TIBCO Module::: Log 3DS - CreateSub Request   --------------");
