...
/**
 * @generated
 *  Flow: ResourceOrder_SDM_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Prep_SA_CreateAUC_TimeOut/Fail_Msg
 */
public class Custom1515699339784 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- AppS_SubmitResourceOrder  TIBCO Module:::  Timeout/Fail while invoking ServiceActivation - CreateAUC -----");
		String sourceKey = "";
