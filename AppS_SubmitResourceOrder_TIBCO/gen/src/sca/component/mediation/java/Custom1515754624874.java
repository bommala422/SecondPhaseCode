...
/**
 * @generated
 *  Flow: ResourceOrder_3DS_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Prep_SA_CreateSub_TimeOut/Fail_Msg
 */
public class Custom1515754624874 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- AppS_SubmitResourceOrder  TIBCO Module:::  Timeout/Fail while invoking ServiceActivation - CreateSub-----");
		String sourceKey = "";
