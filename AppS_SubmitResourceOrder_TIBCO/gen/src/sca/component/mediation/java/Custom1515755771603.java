...
/**
 * @generated
 *  Flow: ResourceOrder_3DS_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Prep_3DS_CreateSubTimeOut_Fail_Msg
 */
public class Custom1515755771603 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		...
		BPMCustomLogger
				.logInfo("----- AppS_SubmitResourceOrder  TIBCO Module:::  Timeout/Fail while invoking 3DS TIBCO AS Module-----");
		String sourceKey = "";
