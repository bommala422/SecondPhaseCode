...
/**
 * @generated
 *  Flow: ResourceOrder_SDM_TIBCO_MED Interface: SubmitResourceOrder Operation: invoke Type: request Custom Mediation: Log_SDM_CreateEIR_Req
 */
public class Custom1518433599322 extends ESBMediationPrimitive {
	...
	public void doMediate(InputTerminal inputTerminal, ServiceMessageObject smo)
		 ...
		 */
		BPMCustomLogger
				.logInfo("----------- AppS_SubmitResourceOrder  TIBCO Module::: Log SDM - CreateEIR Request   --------------");
