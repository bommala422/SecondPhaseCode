...
<!-- @generated mapFile="xslt/Map_3DS_CretaeSub_Resp.map" md5sum="d62935af53b50268cb849c701f8a3813" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		Map_3DS_CretaeSub_Resp.map
*   Map declaration(s):	Map_3DS_CretaeSub_Resp
*   Input file(s):		smo://smo/name%3Dwsdl-primary/sharedContext%3D%257Bhttp%253A%252F%252FAS_SubmitResourceOrder_TIBCO%257DTibco_SharedBO/message%3D%257Bhttp%253A%252F%252Fthree.co.uk%252Fwsdl%252Fresourceorder-3ds%252Fv1%257DaddRequestResponse/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:map="http://AppS_SubmitResourceOrder_TIBCO/xslt/Map_3DS_CretaeSub_Resp"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Map_3DS_CretaeSub_Resp2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:Map_3DS_CretaeSub_Resp"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:Map_3DS_CretaeSub_Resp">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:Map_3DS_CretaeSub_Resp2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out12:invokeResponseMsg'"/>
