...
<!-- @generated mapFile="xslt/Map_3DS_ModifySub_Resp.map" md5sum="0b0de397a7b394848f6894cfd79f24ab" version="8.0.400" -->
<!--
*****************************************************************************
*   This file has been generated by the IBM XML Mapping Editor.
*
*   Mapping file:		Map_3DS_ModifySub_Resp.map
*   Map declaration(s):	Map_3DS_ModifySub_Resp
*   Input file(s):		smo://smo/name%3Dwsdl-primary/sharedContext%3D%257Bhttp%253A%252F%252FAS_SubmitResourceOrder_TIBCO%257DTibco_SharedBO/message%3D%257Bhttp%253A%252F%252Fthree.co.uk%252Fwsdl%252Fresourceorder-3ds%252Fv1%257DmodifyRequestResponse/xpath%3D%252F/smo.xsd
...
<xsl:stylesheet
    ...
    xmlns:in2="wsdl.http://three.co.uk/wsdl/resourceorder-3ds/v1"
    xmlns:in3="urn:siemens:names:prov:gw:H3GSUBSCRIBER:1:0"
    ...
    xmlns:in="urn:siemens:names:prov:gw:SPML:2:0"
    ...
    xmlns:map="http://AppS_SubmitResourceOrder_TIBCO/xslt/Map_3DS_ModifySub_Resp"
  ...
  <xsl:template match="/">
    <xsl:choose>
      <xsl:when test="msl:datamap">
        <msl:datamap>
          <xsl:element name="dataObject">
            ...
            <xsl:call-template name="map:Map_3DS_ModifySub_Resp2">
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="io3:smo" mode="map:Map_3DS_ModifySub_Resp"/>
      </xsl:otherwise>
    </xsl:choose>
  </xsl:template>

  <!-- This rule represents an element mapping: "io3:smo" to "io3:smo".  -->
  <xsl:template match="io3:smo"  mode="map:Map_3DS_ModifySub_Resp">
    <io3:smo>
      <body>
        <xsl:attribute name="xsi:type">
  ...
  <xsl:template name="map:Map_3DS_ModifySub_Resp2">
    <xsl:param name="smo"/>
    <body>
      <xsl:attribute name="xsi:type">
        <xsl:value-of select="'out12:invokeResponseMsg'"/>
